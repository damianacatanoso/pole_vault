...
// CRC-16 (IBM/ANSI) - polynomial representation : 0x8005
unsigned short calculate_crc(unsigned short crc_accum, unsigned char *data_blk_ptr, unsigned short data_blk_size) {
  unsigned short i, j;
